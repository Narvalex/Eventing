...
{
    // Based on: https://stackoverflow.com/a/36648201/2639612
    public sealed class ChildProcessManagement : IDisposable
    {
        private SafeJobHandle _handle;
        private bool _disposed;

        public ChildProcessManagement()
        {
        ...
        {
            if (_disposed) throw new ObjectDisposedException(nameof(ChildProcessManagement));
        }
