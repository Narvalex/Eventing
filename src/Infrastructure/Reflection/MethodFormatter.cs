...
namespace Infrastructure.Reflection
{
    public static class MethodFormatter
    {
        ...
        private static void WriteMethodBody(TextWriter writer, MethodBase method)
        {
        ...
        private static void WriteOperand(TextWriter writer, Instruction instruction)
        {
        ...
        private static void WriteLabelList(TextWriter writer, Instruction[] targets)
        {
            writer.Write("(");
        ...
        private static void WriteFieldReference(TextWriter writer, FieldInfo field)
        {
        ...
        private static void WriteMethodReference(TextWriter writer, MethodBase method)
        {
