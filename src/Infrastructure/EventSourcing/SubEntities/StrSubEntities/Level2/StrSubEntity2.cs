...
{
    public abstract class StrSubEntity2<T> : StrSubEntity2Base where T : StrSubEntity2<T>
    {
        private int? _cachedHash;

        protected StrSubEntity2(string id) : base(id)
        {
        }
        ...
        public static bool operator ==(StrSubEntity2<T> x, StrSubEntity2<T> y)
        {
