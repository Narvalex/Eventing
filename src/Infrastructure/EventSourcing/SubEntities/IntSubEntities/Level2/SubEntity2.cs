...
{
    public abstract class SubEntity2<T> : SubEntity2Base where T : SubEntity2<T>
    {
        private int? _cachedHash;

        protected SubEntity2(int id) : base(id)
        {
        }
        ...
        public static bool operator ==(SubEntity2<T> x, SubEntity2<T> y)
        {
