...
{
    public abstract class StrSubEntity<T> : StrSubEntityBase where T : StrSubEntity<T>
    {
        private int? _cachedHash;

        protected StrSubEntity(string id) : base(id)
        {
        }
        ...
        public static bool operator ==(StrSubEntity<T> x, StrSubEntity<T> y)
        {
